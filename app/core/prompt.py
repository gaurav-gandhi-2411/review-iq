...
- topics: Relevant product topics from the review. Use snake_case. Examples: battery, build_quality, noise, suction, price, customer_service, packaging, delivery, durability, design, performance.
...
_EXAMPLES = """
Example — no stars stated, mixed review:
Review: "The suction is amazing but battery only lasts 20 minutes. For $250 I expected more. Would buy Dyson next time."
Output: {"product": "...", "stars": null, "stars_inferred": 3, "pros": ["amazing suction"], "cons": ["short battery life", "poor value for price"], "buy_again": false, "sentiment": "mixed", "topics": ["suction", "battery", "price"], "competitor_mentions": ["Dyson"], "urgency": "low", "feature_requests": [], "language": "en", "confidence": 0.9}
