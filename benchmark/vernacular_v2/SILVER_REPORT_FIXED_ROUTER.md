...
|---|---|---|---|---|
| flipkart-199635 | hi-en-missed | painsa wasool | llama-3.3-70b-versatile=None, gpt-oss-120b=positive, qwen3-32b=negative | positive |
...
| ID | Slice | Text | Model votes | v2.3 predicted |
|---|---|---|---|---|
| flipkart-199635 | hi-en-missed | painsa wasool | llama-3.3-70b-versatile=None, gpt-oss-120b=low, qwen3-32b=medium | low |
...
| flipkart-168504 | hi-en-missed | Totally faltu ptoduct.waste for money....trust has grown from the Flipkart authority.... | llama-3.3-70b-versatile=None, gpt-oss-120b=en, qwen3-32b=hi-en | hi-en |
