...
export default function LogoMark({ size = 32 }: Props) {
  return (
    ...
    >
      <defs>
        <linearGradient id="log-dark" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#5A3420" />
          <stop offset="100%" stopColor="#8A4B26" />
        </linearGradient>
        <linearGradient id="log-light" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <g strokeLinecap="round" fill="none">
        <line x1="17.82" y1="22.15" x2="11.32" y2="10.89" strokeWidth="5.2" stroke="url(#log-dark)" />
        <line x1="16.58" y1="22.31" x2="14.50" y2="10.49" strokeWidth="4.2" stroke="url(#log-light)" />
        <line x1="15.42" y1="22.31" x2="17.50" y2="10.49" strokeWidth="4.2" stroke="url(#log-light)" />
        <line x1="14.18" y1="22.15" x2="20.68" y2="10.89" strokeWidth="5.2" stroke="url(#log-dark)" />
      </g>
